      ...
      <div class="modal-body">
        ...
        <form class="form-signin" method="POST" action="access/checar.php">
          <div class="form-group">    
            ...
            <input type="email" class="form-control" name="email" id="email" aria-describedby="emailHelp" placeholder="Digite o E-mail" required="">              
          </div>
          <div class="form-group">
      ...
      <div class="modal-body">        
        <form method="POST" action="escola/proc-cad-escola.php">
          <div class="form-group">    
            ...
            <input type="text" class="form-control" name="nome" id="nome" aria-describedby="emailHelp" placeholder="Digite o nome da Instituição" required="">              
          </div>          
          <div class="form-group">    
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="fone" id="fone" placeholder="Digite o Telefone" required="">
          </div>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="rua" id="rua" placeholder="Digite a Rua/Avenida/Caminho" required="">
          </div>
          <div class="form-group">
            <label for="numero"> Número: </label>
            <input type="text" class="form-control" name="numero" id="numero" placeholder="Digite o Número da casa / prédio" required="">
          </div>
          <div class="form-group">
            <label for="bairro"> Bairro/Conjunto: </label>
            <input type="text" class="form-control" name="bairro" id="bairro" placeholder="Digite o Bairro/Conjunto" required="">
          </div>
          <div class="form-group">
            <label for="complemento"> Complemento: </label>
            <input type="text" class="form-control" name="complemento" id="complemento" placeholder="Digite o Complemento" required="">
          </div>
          <div class="form-group">
            <label for="ponto_referencia"> Ponto de Referência: </label>
            <input type="text" class="form-control" name="ponto_referencia" id="ponto_referencia" placeholder="Digite o Ponto de Referência" required="">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="estado" id="estado" placeholder="Digite o Estado / UF" required="">
          </div>
          <div class="form-group">

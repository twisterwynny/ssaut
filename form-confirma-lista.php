...
$qtd_alunos_lista = $_GET['qtd_alunos_lista'];
$qtd_alunos_agenda = $_GET['qtd_alunos_agenda'];
$data = $_GET['data'];
$hora = $_GET['hora'];
...
$turma_lista = $_GET['turma_lista']; // ID turma
...
$_SESSION['qtd_alunos_lista'] = $qtd_alunos_lista;    
$_SESSION['qtd_alunos_agenda'] = $qtd_alunos_agenda;    
$_SESSION['data'] = $data;
$_SESSION['hora'] = $hora;
$_SESSION['escola'] = $escola;
$_SESSION['turma_lista'] = $turma_lista;
        ...
        <div class="fluid-container" id="">
            <div id="" class="text-center" style="color:#000">
                <div id="ceu" class="img_fundo" style="padding-bottom: 28.5%; padding-top: 0%">
                    ...
                    <form id="form-confirma-visita" method="POST" action="confirma-lista.php">
                        <font color="white">
                            <?php
                            echo "Olá! ". $nome . " você foi selecionado na LISTA DE ESPERA para o evento " . $title . " no dia " . $data . " as " . $hora . " com a sua turma de " . $frase . $nome_turma;
                            ?>

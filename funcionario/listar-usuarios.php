...
<html lang="pt-br">
	...
	<body>
		<div class="container"> <!-- afasta o conteúdo da margem esquerda -->
			...
			<a href="listar-usuarios.php">Listar</a><br>
			<a href="pesquisar-usuarios.php">Pesquisar</a><br>
			...
			for($pagina_anterior = $pagina - $max_links; $pagina_anterior <= $pagina - 1; $pagina_anterior++)
			{
				...
				{					
					echo "<a href='listar-usuarios.php?pagina=$pagina_anterior'>$pagina_anterior</a> ";
				}
			}
			...
			for($pagina_seguinte = $pagina + 1; $pagina_seguinte <= $pagina + $max_links; $pagina_seguinte++)
			{
				...
				{					
					echo "<a href='listar-usuarios.php?pagina=$pagina_seguinte'>$pagina_seguinte</a> ";
				}
			}			
			
			echo "<a href='listar-usuarios.php?pagina=$total_de_paginas'>Ultima</a>";
